...
use windows::{
    ...
    Win32::{
        ...
        System::{Threading, WinRT::EventRegistrationToken},
        UI::WindowsAndMessaging::{self, MSG, WINDOW_LONG_PTR_INDEX},
    },
};
...
pub type WebViewSender = mpsc::Sender<Box<dyn FnOnce(WebView) + Send>>;
...
impl WebView {
    pub fn create(parent: HWND, debug: bool) -> Result<WebView> {
        let environment = {
    ...
    pub fn get_sender(&self) -> WebViewSender {
        self.tx.clone()
    }
